...
let questions = {
    SCP: {
        ...
        answers: {
            ...
            es: ["SNAP (asistencia alimentaria)", "Medicaid", "ADC (asistencia en dinero)", "FDPIR (Food Distribution Program on Indian Reservations)", "Mi hijo no está inscrito en ninguno de estos programas", "No lo sé"]
        },
    ...
    SCS: {
        ...
        answers: {
            ...
            es: ["Un estudiante sin hogar", "En Hogar de Acogida (foster care)", "Fugado", "Mi hijo no ha sido identificado como ninguna de estas personas", "No lo sé"]
        },
